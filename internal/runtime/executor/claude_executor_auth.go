...
func (e *ClaudeExecutor) fetchClaudeOAuthProfile(ctx context.Context, auth *cliproxyauth.Auth, apiKey string) (*claudeauth.OAuthProfile, error) {
	...
	defer cancelProfile()
	service := claudeauth.NewClaudeAuthWithProxyURLAndSourceIP(e.cfg, auth.ProxyURL, auth.SourceIP)
...
func (e *ClaudeExecutor) Refresh(ctx context.Context, auth *cliproxyauth.Auth) (*cliproxyauth.Auth, error) {
	...
	svc := claudeauth.NewClaudeAuthWithProxyURLAndSourceIP(e.cfg, auth.ProxyURL, auth.SourceIP)
