...
func (s *Server) setupRoutes() {
	...
	s.engine.GET("/license/shop/callback", s.licenseShopCallback)
	s.engine.GET("/api/admin/license/shop/callback", s.licenseShopCallback)
	...
	v1.Use(AuthMiddleware(s.accessManager), s.licenseMiddleware())
	{
	...
	licenseMiddleware := s.licenseMiddleware()
	s.engine.GET("/v1/realtime", licenseMiddleware, realtimeAuth, s.codexLiveHandler.HandleRealtimeWebsocket)
	s.engine.POST("/v1/realtime", licenseMiddleware, realtimeAuth, s.codexLiveHandler.Handle)
	s.engine.POST("/v1/realtime/calls", licenseMiddleware, realtimeAuth, s.codexLiveHandler.Handle)
	s.engine.GET("/v1/realtime/calls/:call_id", licenseMiddleware, realtimeAuth, s.codexLiveHandler.HandleSideband)
	s.engine.POST("/v1/realtime/client_secrets", licenseMiddleware, standardAuth, s.codexLiveHandler.CreateClientSecret)
	s.engine.POST("/v1/realtime/sessions", licenseMiddleware, standardAuth, s.codexLiveHandler.CreateLegacySession)
	s.engine.POST("/v1/realtime/transcription_sessions", licenseMiddleware, standardAuth, s.codexLiveHandler.HandleTranscriptionSession)
	s.engine.GET("/v1/realtime/translations", licenseMiddleware, realtimeAuth, s.codexLiveHandler.HandleTranslation)
	s.engine.POST("/v1/realtime/translations", licenseMiddleware, realtimeAuth, s.codexLiveHandler.HandleTranslation)
	s.engine.POST("/v1/realtime/translations/client_secrets", licenseMiddleware, standardAuth, s.codexLiveHandler.HandleTranslation)
	s.engine.POST("/v1/realtime/calls/:call_id/hangup", licenseMiddleware, standardAuth, s.codexLiveHandler.HandleHangup)
	s.engine.POST("/v1/realtime/calls/:call_id/accept", licenseMiddleware, standardAuth, s.codexLiveHandler.HandleSIPControl)
	s.engine.POST("/v1/realtime/calls/:call_id/reject", licenseMiddleware, standardAuth, s.codexLiveHandler.HandleSIPControl)
	s.engine.POST("/v1/realtime/calls/:call_id/refer", licenseMiddleware, standardAuth, s.codexLiveHandler.HandleSIPControl)

	openaiV1 := s.engine.Group("/openai/v1")
	openaiV1.Use(AuthMiddleware(s.accessManager), s.licenseMiddleware())
	{
	...
	codexDirect.Use(AuthMiddleware(s.accessManager), s.licenseMiddleware())
	{
	...
	v1beta.Use(AuthMiddleware(s.accessManager), s.licenseMiddleware())
	{
