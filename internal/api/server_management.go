...
func (s *Server) registerManagementRoutes() {
	...
	adminLicense := s.engine.Group("/api/admin/license")
	adminLicense.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		adminLicense.GET("/status", s.getLicenseStatus)
		adminLicense.GET("/shop/start", s.startLicenseShopAuthorization)
		adminLicense.POST("/shop/exchange", s.exchangeLicenseShopCode)
		adminLicense.POST("/refresh", s.refreshLicense)
		adminLicense.POST("/activate", s.activateLicense)
	}
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/license/status", s.getLicenseStatus)
		mgmt.GET("/license/shop/start", s.startLicenseShopAuthorization)
		mgmt.POST("/license/shop/exchange", s.exchangeLicenseShopCode)
		mgmt.POST("/license/refresh", s.refreshLicense)
		mgmt.POST("/license/activate", s.activateLicense)
		...
		mgmt.GET("/plugins/cpa-advanced-core/status", s.mgmt.GetCPAAdvancedPluginStatus)
		mgmt.GET("/plugins/cpa-advanced-core/versions", s.mgmt.ListCPAAdvancedPluginVersions)
		mgmt.POST("/plugins/cpa-advanced-core/download", s.mgmt.DownloadCPAAdvancedPlugin)
		mgmt.POST("/plugins/cpa-advanced-core/install", s.mgmt.InstallCPAAdvancedPlugin)
		mgmt.POST("/plugins/cpa-advanced-core/upgrade", s.mgmt.UpgradeCPAAdvancedPlugin)
		mgmt.POST("/plugins/cpa-advanced-core/rollback", s.mgmt.RollbackCPAAdvancedPlugin)
		...
		mgmt.GET("/api-key-group-policies", s.mgmt.GetAPIKeyGroupPolicies)
		mgmt.PUT("/api-key-group-policies", s.mgmt.PutAPIKeyGroupPolicies)
		mgmt.DELETE("/api-key-group-policies", s.mgmt.DeleteAPIKeyGroupPolicy)

		mgmt.GET("/account-groups", s.mgmt.ListAccountGroups)
		mgmt.POST("/account-groups", s.mgmt.CreateAccountGroup)
		mgmt.PATCH("/account-groups/:id", s.mgmt.UpdateAccountGroup)
		mgmt.DELETE("/account-groups/:id", s.mgmt.DeleteAccountGroup)
		mgmt.PUT("/account-groups/memberships", s.mgmt.PutAccountGroupMemberships)
		...
		mgmt.GET("/routing/new-candidate-mode", s.mgmt.GetRoutingNewCandidateMode)
		mgmt.PUT("/routing/new-candidate-mode", s.mgmt.PutRoutingNewCandidateMode)
		mgmt.PATCH("/routing/new-candidate-mode", s.mgmt.PutRoutingNewCandidateMode)
