#!/usr/bin/env bash
# Bootstrap and operate the public CPA pool stack (bundle v7.2.148-cpa.8).
#
...
set_env CPA_IMAGE "$(value_or CPA_IMAGE ghcr.io/abc124774961/cli-proxy-api-cpa:v7.2.148-cpa.8)"
